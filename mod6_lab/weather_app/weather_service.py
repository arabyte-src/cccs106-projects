...
class WeatherService:
    ...
    async def get_weather(self, city: str, unit: Optional[str] = None) -> Dict:
        """
        Fetch weather data for a given city.

        Args:
            city: Name of the city
            unit: 'metric' for Celsius, 'imperial' for Fahrenheit (defaults to Config.UNITS)
        ...
        params = {
            "q": city,
            "appid": self.api_key,
            "units": unit or Config.UNITS,  # use provided unit or default
        }
    ...
    async def get_weather_by_coordinates(
        self, lat: float, lon: float, unit: Optional[str] = None
    ) -> Dict:
        """
    ...
    async def get_forecast(self, city: str, unit: Optional[str] = None) -> Dict:
